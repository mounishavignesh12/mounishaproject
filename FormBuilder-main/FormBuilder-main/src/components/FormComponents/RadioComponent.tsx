...
const RadioComponent = ({ field, handleOpen, handleResponseObject }: any) => {
  ...
  return (
    <div>
      <form onSubmit={formik.handleSubmit}>
        ...
        <div className="flex justify-between mx-1 my-2"><label htmlFor="placeholder">Value</label><button className="text-blue-600 cursor-pointer" onClick={(e) => clearButtonHandler(e)}>Clear default options</button></div>

        <CreatableSelect
          isClearable
          isMulti
          onChange={(value) => handleChange(value)}
          options={field.value && !clear?  field.value : undefined}
          value={value}
          />
